...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-gray-700 bg-gray-900 text-white mt-12">
      <div className="mx-auto max-w-7xl px-4">
        {/* メインフッター */}
        <div className="grid grid-cols-2 gap-8 py-8 text-xs md:grid-cols-4">
          <div>
            <h3 className="mb-3 font-bold text-white">ナビゲーション</h3>
          ...
          <div>
            <h3 className="mb-3 font-bold text-white">特集で探す</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="mb-3 font-bold text-white">深掘りガイド</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="mb-3 font-bold text-white">運営情報</h3>
            <ul className="space-y-2">
              {aboutLinks.map((item) => (
                <li key={item.href}>
                  <Link href={item.href} className="text-gray-300 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-700 py-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex gap-4">
              ...
              <a href="https://www.youtube.com" className="text-gray-400 hover:text-white transition-colors" aria-label="YouTube">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
